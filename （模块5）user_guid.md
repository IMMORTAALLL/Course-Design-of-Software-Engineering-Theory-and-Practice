...
![截图](figs/e2e-20260617/02-login-home.png)
...
3. 点击某个板块进入板块详情页。
4. 在板块详情页查看该板块下的帖子列表。
![截图](figs/e2e-20260617/4.png)
![截图](figs/e2e-20260617/5.png)
### 2. 查看帖子详情
...
3. 系统跳转到搜索结果页，展示相关帖子。
4. 点击结果进入帖子详情。
![截图](figs/e2e-20260617/6.png)
![截图](figs/e2e-20260617/7.png)
### 2. 热榜

1. 点击顶部导航栏“热榜”。
2. 查看系统按热度整理的热门内容。
3. 点击热门帖子进入详情页继续浏览和互动。
![截图](figs/e2e-20260617/8.png)
## 七、发布内容
...
![后台概览截图](figs/e2e-20260617/16.png)
...
![后台概览截图](figs/e2e-20260617/17.png)
### 3. 举报处理
...
![后台概览截图](figs/e2e-20260617/18.png)
### 6. 统计看板

统计看板用于查看系统运行数据，例如用户增长、内容数量、互动数量和举报处理情况。
![后台概览截图](figs/e2e-20260617/19.png)
## 十六、移动端访问
